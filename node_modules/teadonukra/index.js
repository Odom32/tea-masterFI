...
console.log(addWord("Welcome", "to luwer!")); // Output: Welcome to luwer!

// Adding the 'luwer' variable
const luwer = "luwer";

// Now you can use the 'luwer' variable in your code
console.log(luwer); // Output: luwer
